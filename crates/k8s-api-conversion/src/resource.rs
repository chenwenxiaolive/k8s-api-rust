...
// =============================================================================
// ResourceClaim: v1alpha3 <-> v1
// =============================================================================

impl Convertible<k8s_api::resource::v1::ResourceClaim>
    for k8s_api::resource::v1alpha3::ResourceClaim
{
    fn convert_to(&self) -> Result<k8s_api::resource::v1::ResourceClaim, ConversionError> {
        Ok(k8s_api::resource::v1::ResourceClaim {
            type_meta: k8s_apimachinery::apis::meta::v1::TypeMeta::new(
            ...
            metadata: self.metadata.clone(),
            spec: convert_resource_claim_spec_v1alpha3_to_v1(&self.spec)?,
            status: self
                .status
                .as_ref()
                .map(convert_resource_claim_status_v1alpha3_to_v1)
                .transpose()?,
        })
    }

    fn convert_from(
        other: &k8s_api::resource::v1::ResourceClaim,
    ) -> Result<Self, ConversionError> {
        Ok(Self {
            type_meta: k8s_apimachinery::apis::meta::v1::TypeMeta::new(
            ...
            metadata: other.metadata.clone(),
            spec: convert_resource_claim_spec_v1alpha3_from_v1(&other.spec)?,
            status: other
                .status
                .as_ref()
                .map(convert_resource_claim_status_v1alpha3_from_v1)
                .transpose()?,
        })
    }
}

fn convert_resource_claim_spec_v1alpha3_to_v1(
    spec: &k8s_api::resource::v1alpha3::ResourceClaimSpec,
) -> Result<k8s_api::resource::v1::ResourceClaimSpec, ConversionError> {
    Ok(k8s_api::resource::v1::ResourceClaimSpec {
        devices: spec
            .devices
            .as_ref()
            .map(convert_device_claim_v1alpha3_to_v1)
            .transpose()?,
    })
}

fn convert_resource_claim_spec_v1alpha3_from_v1(
    spec: &k8s_api::resource::v1::ResourceClaimSpec,
) -> Result<k8s_api::resource::v1alpha3::ResourceClaimSpec, ConversionError> {
    Ok(k8s_api::resource::v1alpha3::ResourceClaimSpec {
        devices: spec
            .devices
            .as_ref()
            .map(convert_device_claim_v1alpha3_from_v1)
            .transpose()?,
        controller: String::new(),
    })
}

fn convert_resource_claim_status_v1alpha3_to_v1(
    status: &k8s_api::resource::v1alpha3::ResourceClaimStatus,
) -> Result<k8s_api::resource::v1::ResourceClaimStatus, ConversionError> {
    Ok(k8s_api::resource::v1::ResourceClaimStatus {
        allocation: status
            .allocation
            .as_ref()
            .map(convert_allocation_result_v1alpha3_to_v1)
            .transpose()?,
        reserved_for: convert_via_json(&status.reserved_for)?,
        devices: status
            .devices
            .iter()
            .map(convert_allocated_device_status_v1alpha3_to_v1)
            .collect::<Result<Vec<_>, _>>()?,
    })
}

fn convert_resource_claim_status_v1alpha3_from_v1(
    status: &k8s_api::resource::v1::ResourceClaimStatus,
) -> Result<k8s_api::resource::v1alpha3::ResourceClaimStatus, ConversionError> {
    Ok(k8s_api::resource::v1alpha3::ResourceClaimStatus {
        allocation: status
            .allocation
            .as_ref()
            .map(convert_allocation_result_v1alpha3_from_v1)
            .transpose()?,
        reserved_for: convert_via_json(&status.reserved_for)?,
        devices: status
            .devices
            .iter()
            .map(convert_allocated_device_status_v1alpha3_from_v1)
            .collect::<Result<Vec<_>, _>>()?,
    })
}

fn convert_allocation_result_v1alpha3_to_v1(
    result: &k8s_api::resource::v1alpha3::AllocationResult,
) -> Result<k8s_api::resource::v1::AllocationResult, ConversionError> {
    Ok(k8s_api::resource::v1::AllocationResult {
        devices: result
            .devices
            .as_ref()
            .map(convert_device_allocation_result_v1alpha3_to_v1)
            .transpose()?,
        node_selector: result.node_selector.clone(),
        allocation_timestamp: None,
    })
}

fn convert_allocation_result_v1alpha3_from_v1(
    result: &k8s_api::resource::v1::AllocationResult,
) -> Result<k8s_api::resource::v1alpha3::AllocationResult, ConversionError> {
    Ok(k8s_api::resource::v1alpha3::AllocationResult {
        devices: result
            .devices
            .as_ref()
            .map(convert_device_allocation_result_v1alpha3_from_v1)
            .transpose()?,
        node_selector: result.node_selector.clone(),
        controller: String::new(),
    })
...
fn convert_device_allocation_result_v1alpha3_to_v1(
    result: &k8s_api::resource::v1alpha3::DeviceAllocationResult,
) -> Result<k8s_api::resource::v1::DeviceAllocationResult, ConversionError> {
    Ok(k8s_api::resource::v1::DeviceAllocationResult {
        results: result
            .results
            .iter()
            .map(convert_device_request_allocation_result_v1alpha3_to_v1)
            .collect(),
        config: convert_via_json(&result.config)?,
    })
}

fn convert_device_allocation_result_v1alpha3_from_v1(
    result: &k8s_api::resource::v1::DeviceAllocationResult,
) -> Result<k8s_api::resource::v1alpha3::DeviceAllocationResult, ConversionError> {
    Ok(k8s_api::resource::v1alpha3::DeviceAllocationResult {
        results: result
            .results
            .iter()
            .map(convert_device_request_allocation_result_v1alpha3_from_v1)
            .collect(),
        config: convert_via_json(&result.config)?,
    })
}

fn convert_device_request_allocation_result_v1alpha3_to_v1(
    result: &k8s_api::resource::v1alpha3::DeviceRequestAllocationResult,
) -> k8s_api::resource::v1::DeviceRequestAllocationResult {
    k8s_api::resource::v1::DeviceRequestAllocationResult {
...
fn convert_device_request_allocation_result_v1alpha3_from_v1(
    result: &k8s_api::resource::v1::DeviceRequestAllocationResult,
) -> k8s_api::resource::v1alpha3::DeviceRequestAllocationResult {
    k8s_api::resource::v1alpha3::DeviceRequestAllocationResult {
        request: result.request.clone(),
        driver: result.driver.clone(),
        pool: result.pool.clone(),
...
fn convert_allocated_device_status_v1alpha3_to_v1(
    status: &k8s_api::resource::v1alpha3::AllocatedDeviceStatus,
) -> Result<k8s_api::resource::v1::AllocatedDeviceStatus, ConversionError> {
    Ok(k8s_api::resource::v1::AllocatedDeviceStatus {
        driver: status.driver.clone(),
        pool: status.pool.clone(),
...
fn convert_allocated_device_status_v1alpha3_from_v1(
    status: &k8s_api::resource::v1::AllocatedDeviceStatus,
) -> Result<k8s_api::resource::v1alpha3::AllocatedDeviceStatus, ConversionError> {
    Ok(k8s_api::resource::v1alpha3::AllocatedDeviceStatus {
        driver: status.driver.clone(),
        pool: status.pool.clone(),
        device: status.device.clone(),
        conditions: status.conditions.clone(),
...
fn convert_device_claim_v1alpha3_to_v1(
    claim: &k8s_api::resource::v1alpha3::DeviceClaim,
) -> Result<k8s_api::resource::v1::DeviceClaim, ConversionError> {
    Ok(k8s_api::resource::v1::DeviceClaim {
        requests: claim
            .requests
            .iter()
            .map(convert_device_request_v1alpha3_to_v1)
            .collect::<Result<Vec<_>, _>>()?,
        constraints: convert_via_json(&claim.constraints)?,
        config: convert_via_json(&claim.config)?,
    })
...
fn convert_device_claim_v1alpha3_from_v1(
    claim: &k8s_api::resource::v1::DeviceClaim,
) -> Result<k8s_api::resource::v1alpha3::DeviceClaim, ConversionError> {
    Ok(k8s_api::resource::v1alpha3::DeviceClaim {
        requests: claim
            .requests
            .iter()
            .map(convert_device_request_v1alpha3_from_v1)
            .collect::<Result<Vec<_>, _>>()?,
        constraints: convert_via_json(&claim.constraints)?,
        config: convert_via_json(&claim.config)?,
    })
...
fn convert_device_request_v1alpha3_to_v1(
    request: &k8s_api::resource::v1alpha3::DeviceRequest,
) -> Result<k8s_api::resource::v1::DeviceRequest, ConversionError> {
    Ok(k8s_api::resource::v1::DeviceRequest {
        name: request.name.clone(),
        exactly: Some(k8s_api::resource::v1::ExactDeviceRequest {
...
fn convert_device_request_v1alpha3_from_v1(
    request: &k8s_api::resource::v1::DeviceRequest,
) -> Result<k8s_api::resource::v1alpha3::DeviceRequest, ConversionError> {
    let (device_class_name, selectors, allocation_mode, count, admin_access) =
        if let Some(exactly) = request.exactly.as_ref() {
            (
                exactly.device_class_name.clone(),
                convert_via_json(&exactly.selectors)?,
            ...
            (String::new(), Vec::new(), String::new(), None, None)
        };

    Ok(k8s_api::resource::v1alpha3::DeviceRequest {
        name: request.name.clone(),
        device_class_name,
        selectors,
        allocation_mode,
...
// =============================================================================
// ResourceClaimTemplate: v1alpha3 <-> v1
// =============================================================================

impl Convertible<k8s_api::resource::v1::ResourceClaimTemplate>
    for k8s_api::resource::v1alpha3::ResourceClaimTemplate
{
    fn convert_to(&self) -> Result<k8s_api::resource::v1::ResourceClaimTemplate, ConversionError> {
        Ok(k8s_api::resource::v1::ResourceClaimTemplate {
            type_meta: k8s_apimachinery::apis::meta::v1::TypeMeta::new(
            ...
            metadata: self.metadata.clone(),
            spec: convert_resource_claim_template_spec_v1alpha3_to_v1(&self.spec)?,
        })
    }
    ...
    fn convert_from(
        ...
        Ok(Self {
            ...
            metadata: other.metadata.clone(),
            spec: convert_resource_claim_template_spec_v1alpha3_from_v1(&other.spec)?,
        })
    }
}

fn convert_resource_claim_template_spec_v1alpha3_to_v1(
    spec: &k8s_api::resource::v1alpha3::ResourceClaimTemplateSpec,
) -> Result<k8s_api::resource::v1::ResourceClaimTemplateSpec, ConversionError> {
    Ok(k8s_api::resource::v1::ResourceClaimTemplateSpec {
        metadata: spec.metadata.clone(),
        spec: convert_resource_claim_spec_v1alpha3_to_v1(&spec.spec)?,
    })
}

fn convert_resource_claim_template_spec_v1alpha3_from_v1(
    spec: &k8s_api::resource::v1::ResourceClaimTemplateSpec,
) -> Result<k8s_api::resource::v1alpha3::ResourceClaimTemplateSpec, ConversionError> {
    Ok(k8s_api::resource::v1alpha3::ResourceClaimTemplateSpec {
        metadata: spec.metadata.clone(),
        spec: convert_resource_claim_spec_v1alpha3_from_v1(&spec.spec)?,
    })
}

// =============================================================================
// DeviceClass: v1alpha3 <-> v1
// =============================================================================

impl Convertible<k8s_api::resource::v1::DeviceClass> for k8s_api::resource::v1alpha3::DeviceClass {
    fn convert_to(&self) -> Result<k8s_api::resource::v1::DeviceClass, ConversionError> {
        Ok(k8s_api::resource::v1::DeviceClass {
            type_meta: k8s_apimachinery::apis::meta::v1::TypeMeta::new(
                "resource.k8s.io/v1",
            ...
            metadata: self.metadata.clone(),
            spec: convert_device_class_spec_v1alpha3_to_v1(&self.spec)?,
        })
    }
    ...
    fn convert_from(other: &k8s_api::resource::v1::DeviceClass) -> Result<Self, ConversionError> {
        Ok(Self {
            ...
            metadata: other.metadata.clone(),
            spec: convert_device_class_spec_v1alpha3_from_v1(&other.spec)?,
        })
    }
}

fn convert_device_class_spec_v1alpha3_to_v1(
    spec: &k8s_api::resource::v1alpha3::DeviceClassSpec,
) -> Result<k8s_api::resource::v1::DeviceClassSpec, ConversionError> {
    Ok(k8s_api::resource::v1::DeviceClassSpec {
        selectors: convert_via_json(&spec.selectors)?,
        config: convert_via_json(&spec.config)?,
        extended_resource_name: None,
    })
}

fn convert_device_class_spec_v1alpha3_from_v1(
    spec: &k8s_api::resource::v1::DeviceClassSpec,
) -> Result<k8s_api::resource::v1alpha3::DeviceClassSpec, ConversionError> {
    Ok(k8s_api::resource::v1alpha3::DeviceClassSpec {
        selectors: convert_via_json(&spec.selectors)?,
        config: convert_via_json(&spec.config)?,
        suitable_nodes: None,
    })
...
// =============================================================================
// ResourceSlice: v1alpha3 <-> v1
// =============================================================================

impl Convertible<k8s_api::resource::v1::ResourceSlice> for k8s_api::resource::v1alpha3::ResourceSlice {
    fn convert_to(&self) -> Result<k8s_api::resource::v1::ResourceSlice, ConversionError> {
        Ok(k8s_api::resource::v1::ResourceSlice {
            type_meta: k8s_apimachinery::apis::meta::v1::TypeMeta::new(
                "resource.k8s.io/v1",
            ...
            metadata: self.metadata.clone(),
            spec: convert_resource_slice_spec_v1alpha3_to_v1(&self.spec)?,
        })
    }
...
fn convert_resource_slice_spec_v1alpha3_to_v1(
    spec: &k8s_api::resource::v1alpha3::ResourceSliceSpec,
) -> Result<k8s_api::resource::v1::ResourceSliceSpec, ConversionError> {
    Ok(k8s_api::resource::v1::ResourceSliceSpec {
        driver: spec.driver.clone(),
        pool: convert_via_json(&spec.pool)?,
        ...
        devices: spec
            .devices
            .iter()
            .map(convert_device_v1alpha3_to_v1)
            .collect::<Result<Vec<_>, _>>()?,
...
fn convert_resource_slice_spec_v1alpha3_from_v1(
    spec: &k8s_api::resource::v1::ResourceSliceSpec,
) -> Result<k8s_api::resource::v1alpha3::ResourceSliceSpec, ConversionError> {
    Ok(k8s_api::resource::v1alpha3::ResourceSliceSpec {
        driver: spec.driver.clone(),
        pool: convert_via_json(&spec.pool)?,
        node_name: spec.node_name.clone().unwrap_or_default(),
        node_selector: spec.node_selector.clone(),
        ...
        devices: spec
            .devices
            .iter()
            .map(convert_device_v1alpha3_from_v1)
            .collect::<Result<Vec<_>, _>>()?,
    })
}

fn convert_device_v1alpha3_to_v1(
    device: &k8s_api::resource::v1alpha3::Device,
) -> Result<k8s_api::resource::v1::Device, ConversionError> {
    let mut converted = k8s_api::resource::v1::Device {
        name: device.name.clone(),
        ..Default::default()
...
fn convert_device_v1alpha3_from_v1(
    device: &k8s_api::resource::v1::Device,
) -> Result<k8s_api::resource::v1alpha3::Device, ConversionError> {
    let basic = k8s_api::resource::v1alpha3::BasicDevice {
        attributes: convert_via_json(&device.attributes)?,
        capacity: convert_via_json(&device.capacity)?,
    };

    Ok(k8s_api::resource::v1alpha3::Device {
        name: device.name.clone(),
        basic: Some(basic),
    })
}
...
mod tests {
    ...
    #[test]
    fn test_resource_claim_v1alpha3_to_v1_conversion() {
        let v1alpha3_claim = k8s_api::resource::v1alpha3::ResourceClaim {
            metadata: ObjectMeta::named("alpha-claim"),
            spec: k8s_api::resource::v1alpha3::ResourceClaimSpec {
                devices: Some(k8s_api::resource::v1alpha3::DeviceClaim {
                    requests: vec![k8s_api::resource::v1alpha3::DeviceRequest {
                        name: "req".to_string(),
                        device_class_name: "gpu".to_string(),
                        selectors: vec![],
                        allocation_mode: "ExactCount".to_string(),
                ...
                controller: "dra.example.com".to_string(),
            },
            ..Default::default()
        };

        let v1_claim: k8s_api::resource::v1::ResourceClaim = v1alpha3_claim.convert_to().unwrap();
        let devices = v1_claim.spec.devices.as_ref().unwrap();
        let request = &devices.requests[0];
        assert_eq!(request.name, "req");
        let exactly = request.exactly.as_ref().unwrap();
        assert_eq!(exactly.device_class_name, "gpu");
        assert_eq!(exactly.count, Some(1));
        assert!(request.first_available.is_empty());
    }

    #[test]
    fn test_resource_slice_v1alpha3_device_basic_conversion() {
        let mut attributes = BTreeMap::new();
        attributes.insert(
            "vendor".to_string(),
            k8s_api::resource::v1alpha3::DeviceAttribute {
                string_value: Some("amd".to_string()),
                ..Default::default()
            },
        );

        let v1alpha3_slice = k8s_api::resource::v1alpha3::ResourceSlice {
            metadata: ObjectMeta::named("alpha-slice"),
            spec: k8s_api::resource::v1alpha3::ResourceSliceSpec {
                driver: "dra.example.com".to_string(),
                pool: k8s_api::resource::v1alpha3::ResourcePool {
                    name: "pool".to_string(),
                    generation: 2,
                    resource_slice_count: 1,
                },
                node_name: "node-b".to_string(),
                devices: vec![k8s_api::resource::v1alpha3::Device {
                    name: "dev1".to_string(),
                    basic: Some(k8s_api::resource::v1alpha3::BasicDevice {
                        attributes,
                        ..Default::default()
                    }),
                }],
        ...
        let v1_slice: k8s_api::resource::v1::ResourceSlice = v1alpha3_slice.convert_to().unwrap();
        let device = &v1_slice.spec.devices[0];
