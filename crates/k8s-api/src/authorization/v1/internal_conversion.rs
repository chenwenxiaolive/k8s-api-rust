...
impl InternalConversion for LabelSelectorAttributes {
    type Internal = crate::authorization::internal::LabelSelectorAttributes;
}

impl InternalConversion for FieldSelectorAttributes {
    type Internal = crate::authorization::internal::FieldSelectorAttributes;
}
