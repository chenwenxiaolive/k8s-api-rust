//! Flow Control v1beta3 type definitions
//!
//! This module provides beta-level API priority and fairness types (K8s 1.26+).
//! Types in this version are being replaced by flowcontrol.apiserver.k8s.io/v1.
