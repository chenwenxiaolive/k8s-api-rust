//! Resource v1beta1 API type definitions for Dynamic Resource Allocation (DRA)
//!
//! This module provides types for dynamic resource allocation (K8s 1.31+).
...
/// DeviceCounterConsumption defines counters consumed by a device.
#[derive(Clone, Debug, Default, PartialEq, Serialize, Deserialize)]
#[serde(rename_all = "camelCase")]
