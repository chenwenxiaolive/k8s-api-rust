...
| autoscaling | 9 | 0 | 3 | 4 | 2 | conversion, validation |
| batch | 3 | 0 | 0 | 2 | 1 | api, conversion, validation |
...
- pkg/apis/apps/v1/defaults_test.go [apps] (defaults) -> missing
- pkg/apis/apps/v1beta1/defaults_test.go [apps] (defaults) -> missing
- pkg/apis/apps/v1beta2/defaults_test.go [apps] (defaults) -> missing
...
- pkg/apis/autoscaling/v1/defaults_test.go [autoscaling] (defaults) -> missing
- pkg/apis/autoscaling/v2/defaults_test.go [autoscaling] (defaults) -> missing
- pkg/apis/autoscaling/v2beta1/defaults_test.go [autoscaling] (defaults) -> missing
- pkg/apis/autoscaling/v2beta2/defaults_test.go [autoscaling] (defaults) -> missing
...
- pkg/apis/batch/v1/defaults_test.go [batch] (defaults) -> missing
- pkg/apis/batch/v1beta1/defaults_test.go [batch] (defaults) -> missing
- pkg/apis/batch/validation/validation_test.go [batch] (validation) -> rust_validation
- pkg/apis/certificates/v1beta1/defaults_test.go [certificates] (defaults) -> missing
...
- pkg/apis/core/v1/conversion_test.go [core] (conversion) -> missing
- pkg/apis/core/v1/defaults_test.go [core] (defaults) -> missing
- pkg/apis/core/helper/helpers_test.go [core] (other) -> unknown
- pkg/apis/core/install/install_test.go [core] (other) -> unknown
- pkg/apis/core/pods/helpers_test.go [core] (other) -> unknown
- pkg/apis/core/taint_test.go [core] (other) -> unknown
- pkg/apis/core/toleration_test.go [core] (other) -> unknown
- pkg/apis/core/v1/helper/helpers_test.go [core] (other) -> unknown
- pkg/apis/core/v1/helper/qos/qos_test.go [core] (other) -> unknown
- staging/src/k8s.io/api/core/v1/taint_test.go [core] (other) -> unknown
- staging/src/k8s.io/api/core/v1/toleration_test.go [core] (other) -> unknown
- pkg/apis/core/types_test.go [core] (types) -> rust_api_tests
- staging/src/k8s.io/api/core/v1/types_test.go [core] (types) -> rust_api_tests
...
- pkg/apis/flowcontrol/internalbootstrap/defaults_test.go [flowcontrol] (defaults) -> missing
- pkg/apis/flowcontrol/v1/defaults_test.go [flowcontrol] (defaults) -> missing
- pkg/apis/flowcontrol/v1beta1/defaults_test.go [flowcontrol] (defaults) -> missing
- pkg/apis/flowcontrol/v1beta2/defaults_test.go [flowcontrol] (defaults) -> missing
...
- pkg/apis/rbac/helpers_test.go [rbac] (other) -> unknown
...
- pkg/apis/resource/v1/defaults_test.go [resource] (defaults) -> missing
- pkg/apis/resource/v1alpha3/defaults_test.go [resource] (defaults) -> missing
- pkg/apis/resource/v1beta1/defaults_test.go [resource] (defaults) -> missing
- pkg/apis/resource/v1beta2/defaults_test.go [resource] (defaults) -> missing
- pkg/apis/resource/install/install_test.go [resource] (other) -> unknown
...
- pkg/apis/storage/v1beta1/defaults_test.go [storage] (defaults) -> missing
